...
export function BottomTabBar({navigation}) {
  ...
  return (
    ...
    <TouchableOpacity
      ...
      >
          <Image source={LocalImages.home} style={styles.icon}/>
...
{/* <Path
      ...
      /> */}
        ...
        <Path
        d="M 100 0 V 110 H 0 V 0 c 7,0 8,0.3 9,3 c 0,0 2,35 39,36.5 c 0,0 34,2 37,-36.5 c 0,0 0,-2.2 3,-3 "
        fill="white"
    ...
    <TouchableOpacity
      ...
      >
          ...
          <Image source={LocalImages.bookmark} style={styles.icon}/>
